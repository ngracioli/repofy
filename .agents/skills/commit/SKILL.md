...
4. Preserve pre-existing staged changes and never include unrelated user changes. If staged changes cannot safely be separated, stop before committing and explain the conflict.
